...
bot.command('info', async (ctx) => {
  ...
  await ctx.reply('Цей бот створений виключно в навчальних цілях. Автор не несе відповідальності за стабільну роботу, адже бот залежить від зовнішнього API tt.sclnau.com.ua та серверів, які він не контролює.\nЦе повністю волонтерський проєкт без зовнішнього фінансування, тому він може припинити існування, коли ресурси закінчаться. <b>За можливості підтримати роботу серверів можна тут: <a href="https://www.privat24.ua/send/ivn0j">Донат</a></b>')
...
bot.command('features', async (ctx) => {
  ...
  ⭐ Можливість вибрати групу, яка буде запам'ятована для швидкого доступу до розкладу
  ☺️ Відносно зручний, та знайомий інтерфейс телеграму`
  .trim()); 
